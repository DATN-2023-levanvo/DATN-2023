    ...
    <div className="nav-left">
      <Layout style={{ minHeight: "100vh" }}>
        ...
        >
          ...
          <hr />
          <Menu theme="dark" defaultSelectedKeys={['0']} mode="inline" items={isStaff ? items.filter((item: any) => item.key !== 'sub1' && item.key !== '6' && item.key !== '7' && item.key !== '11' && item.key !== '10' && item.key !=='12') : items} />
        </Sider>
        <Layout>
